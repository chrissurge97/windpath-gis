    ...
    return (
      <div className="flex flex-col items-center justify-center h-full bg-slate-950 gap-6">
        <div className="text-center mb-2">
          <img src="/src/assets/logo-main.png" alt="EagleView" className="w-64 h-64 object-contain mx-auto mb-3 rounded" />
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 relative min-w-0" style={{ cursor: cursorStyle }}>
          ...
          <PointMenu
            ...
            layers={layers}
            onApply={({ name, notes, setback_m, no_turbines, radii, layerId: newLayerId, custom_fields }) => {
              const oldLayer = layers.find((l) => l.id === pointMenuLayerId);
              const updatedFeature = { ...pointMenuFeature, properties: { ...pointMenuFeature.properties, name, notes, setback_m, no_turbines, radii, ...custom_fields } };
