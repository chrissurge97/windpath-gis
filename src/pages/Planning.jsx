    ...
    return (
      <div className="flex flex-col items-center justify-center h-full bg-slate-950 gap-6">
        <div className="text-center mb-2">
          <img src="https://media.base44.com/images/public/69e640f4781807594008e037/cccee274d_IconGreen.png" alt="EagleView" className="w-32 h-32 object-contain mx-auto mb-3" />
