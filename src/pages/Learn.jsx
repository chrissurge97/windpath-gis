...
import {
  ...
  BookOpen, ArrowRight, Trash2, Settings, X } from
'lucide-react';
          ...
          <AnimatePresence>
            {showPassed &&
              <motion.div
                ...
                className="absolute left-1/2 top-1/2 pointer-events-none select-none pt-1"
                style={{ zIndex: 10, transform: 'translateX(calc(-40%)) translateY(calc(-40% ))' }}>
